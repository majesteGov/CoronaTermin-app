...
public class qrcodeCoronaApp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	// Definition du contenu du QR Code
    	...
    	//Declaration du contenu du QR Code, de l'emplacement et du nom du fichier, ainsi que de la largeur et de la hauteur de l'image
        ...
        try {
            // Generation de la matrice du QR Code a partir des parametres definis
            BitMatrix matrix = new MultiFormatWriter().encode(data, BarcodeFormat.QR_CODE, width, height);
            
            // Ecriture de la matrice dans le flux de sortie de la reponse HTTP
            response.setContentType("image/png");
            MatrixToImageWriter.writeToStream(matrix, "png", response.getOutputStream());
            
        } catch (WriterException | IOException e) {
            // Gestion des erreurs de generation du QR Code
            System.err.println("Erreur lors de la creation de l'image : " + e.getMessage());
        }
    }
}
