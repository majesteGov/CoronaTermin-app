...
public class loginCoronaApp extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try (Connection conn = DatabaseConnection.getConnection();
			...
			// Creation du thread pour la verification des informations de connexion
			...
			// Demarrage du thread pour la vérification des informations de connexion
			verifyLoginThread.start();

			// Attente du thread pour la verification des informations de connexion
			try {
